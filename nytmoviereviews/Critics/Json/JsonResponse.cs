...
namespace Nyt.Critics.Json {
    public class JsonResponse : IAdditionalDataHolder, IParsable {
        ...
        public List<Critic> Results { get; set; }
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"results", n => { Results = n.GetCollectionOfObjectValues<Critic>(Critic.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Critic>("results", Results);
