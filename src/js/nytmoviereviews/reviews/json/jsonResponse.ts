...
export class JsonResponse implements AdditionalDataHolder, Parsable {
    ...
    private _results?: Movie[] | undefined;
    /** The status property */
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "results": n => { this.results = n.getCollectionOfObjectValues<Movie>(createMovieFromDiscriminatorValue); },
     ...
     */
    public set results(value: Movie[] | undefined) {
        this._results = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Movie>("results", this.results);
