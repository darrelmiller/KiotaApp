...
namespace Nyt.Models {
    public class Critic_multimedia_resource : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public Critic_multimedia_resource() {
        ...
        /// </summary>
        public static Critic_multimedia_resource CreateFromDiscriminatorValue(IParseNode parseNode) {
