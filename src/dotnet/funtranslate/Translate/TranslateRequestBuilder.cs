using ApiSdk.Translate.Cheunh;
using ApiSdk.Translate.Gungan;
using ApiSdk.Translate.Huttese;
using ApiSdk.Translate.Mandalorian;
using ApiSdk.Translate.Sith;
using ApiSdk.Translate.Yoda;
