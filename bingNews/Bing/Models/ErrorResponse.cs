...
namespace Bing.Models {
    /// <summary>The top-level response that represents a failed request.</summary>
    public class ErrorResponse : Response, IParsable {
        ...
        /// </summary>
        public static new ErrorResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
